...
const About = () => {
    return (
        <section id="about" className="py-32  relative overflow-hidden">
            {/* Background Elements */}
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-violet-900/20 blur-[128px] rounded-full pointer-events-none" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <div className="relative aspect-square rounded-2xl overflow-hidden border border-white/10">
                            ...
                            {/* Overlay Gradient */}
                            <div className="absolute inset-0 bg-gradient-to-t from-[#0a0118]/80 via-transparent to-transparent" />
                        </div>

                        {/* Decorative Elements */}
                        <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-violet-600 rounded-full blur-2xl opacity-50" />
                        <div className="absolute -top-6 -left-6 w-32 h-32 bg-fuchsia-600 rounded-full blur-3xl opacity-30" />
                    </motion.div>
