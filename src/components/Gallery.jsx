...
const thumbnails = [
    ...
    { id: 27, title: "Where Are They Now", image: "/thumbnails/WWR17B2.jpg" },
    { id: 27, title: "Where Are They Now", image: "/thumbnails/WWR20B.jpg" },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {thumbnails.map((item, index) => (
                        ...
                        >
                            ...
                            {/* Glow Effect */}
                            <div className="absolute inset-0 bg-[#0a0118]/0 group-hover:bg-[#0a0118]/60 transition-colors duration-300" />

                            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <button
                                    onClick={() => setSelectedImage(item)}
                                    className="px-6 py-3 bg-[#0a0118]/80 backdrop-blur-md rounded-full text-white font-medium border border-white/10 hover:border-white/30 transition-all duration-300"
                                >
                                    View Project
                                </button>
                            </div>
            ...
            <AnimatePresence>
                {selectedImage && (
                    <motion.div
                        ...
                        className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0a0118]/90 backdrop-blur-lg"
                    >
                        {/* Close Button */}
                        <button
                            onClick={() => setSelectedImage(null)}
